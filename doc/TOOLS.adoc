...
Versions from 6.0 to 7.1 are known to work.
Versions 7.2 or more recent are known to *not* work.
...
6. Install QEMU 7.1 for Windows (qemu-w64-setup-20220831) from https://qemu.weilnetz.de/w64/
